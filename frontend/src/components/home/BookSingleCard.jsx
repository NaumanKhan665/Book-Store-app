...
import { AiFillTwitterCircle, AiOutlineEdit } from 'react-icons/ai'
...
const BookSingleCard=({book})=>{
  return (
    ...
    <div key={book.id} className='border-2 border-gray-500  rounded-log px-4 py-2 m-4 relative shadow-xl'>
